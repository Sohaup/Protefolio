...
return new class extends Migration
{
    ...
    {
        Schema::create('last_replay_comments', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('replay_user_id')->nullable(false);
            $table->timestamps();
            ...
            $table->foreign('replay_user_id')->references('id')->on('users')->onDelete('cascade')->onUpdate('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('last_replay_comments');
    }
};
